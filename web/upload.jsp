...
<%
    ...
    if(isMultipart){
        ...
        while (itr.hasNext()){
            ...
            if (item.isFormField())
            {
                ...
                else if(type.equals("image/pjpeg") || type.equals("image/jpeg") || type.equals("image/png") || type.equals("image/x-png") || type.equals("image/gif") && size<400){
    ...
    try{
        ...
        PreparedStatement ps = con.prepareStatement("insert into test values('"+name+"','"+email+"','"+password+"','"+i+"')");
